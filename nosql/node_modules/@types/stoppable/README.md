...
ms.locfileid: "138051048"
---
# <a name="installation"></a>Installazione
> `npm install --save @types/stoppable`

# <a name="summary"></a>Riepilogo
Questo pacchetto contiene le definizioni dei tipi per stoppable (https://github.com/hunterloftis/stoppable).

# <a name="details"></a>Dettagli
I file sono stati esportati da https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/stoppable.
 ...
 * Ultimo aggiornamento: Lun, 31 maggio 2021 17:01:23 GMT
 * Dipendenze: [@types/node](https://npmjs.com/package/@types/node)
 * Valori globali: nessuno

# <a name="credits"></a>Credits
Queste definizioni sono state scritte da [Eric Byers](https://github.com/EricByers), [John Plusjé](https://github.com/jplusje) e [BendingBender](https://github.com/BendingBender).
