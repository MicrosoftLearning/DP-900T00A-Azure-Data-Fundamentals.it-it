...
ms.locfileid: "138051460"
---
# <a name="nodejs-abi"></a>ABI Node.js

[![Stato della compilazione](https://travis-ci.org/lgeiger/node-abi.svg?branch=v1.0.0)](https://travis-ci.org/lgeiger/node-abi)[![Badge Greenkeeper](https://badges.greenkeeper.io/lgeiger/node-abi.svg)](https://greenkeeper.io/)


Ottenere l'interfaccia ABI di Node per una destinazione e un runtime specificati e viceversa.
